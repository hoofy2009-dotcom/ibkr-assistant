...
| 计划 | 请求限额 | 功能 |
|------|----------|------|
| **Free** | **60次/分钟** | 实时报价、分析师评级、机构持股、新闻 |
| Starter | 300次/分钟 | 全部功能 + 历史数据 |
| Pro | 600次/分钟 | 全部功能 + 更多历史 |

> **提示**：免费版已经完全够用！每分钟60次足够获取所有面板数据。
...
4. 查找以下日志：
   ...
   👔 Finnhub分析师数据: {strongBuy: 5, buy: 10, ...}
   🏦 使用Finnhub API获取机构持股: TSLA
   ```
...
**解决方案**：
1. API 密钥可能已过期或被禁用
2. 登录 https://finnhub.io/dashboard 检查状态
